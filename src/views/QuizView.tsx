...
export const QuizView = () => {
  ...
  const { questions, currentIdx, score, status, timeLeft, answerQuestion, tick, finishQuiz } = useQuizStore();
    ...
    <div className="mx-auto max-w-[960px] px-4 py-12 md:py-24">
      <div className="mb-12 flex items-end justify-between border-b border-hairline pb-4">
        <div>
          ...
          <div className="text-[14px] text-mute">Answered: {score.answered}</div>
        </div>
        <div className="text-[16px] font-bold text-ink">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Card className="mb-8">
            <h2
              className="text-[16px] font-bold leading-[1.5] text-ink"
