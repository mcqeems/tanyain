  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-4 relative">
      <motion.button
        ...
        className="absolute top-6 right-6 flex items-center justify-center h-12 w-12 rounded-full bg-surface-card text-ink hover:bg-surface-soft border border-hairline-strong transition-colors"
        aria-label="Settings"
      >
        <Settings size={20} />
      </motion.button>
